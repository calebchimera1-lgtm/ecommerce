<?php /** @var string $name @var string $productName @var string $productUrl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Your product listing was approved</title>
</head>
                    ...
                    <tr>
                        <td style="padding:32px;text-align:center;">
                            ...
                            <p style="color:#cfcfcf;font-size:14px;line-height:1.6;">
                                Good news - <strong><?= htmlspecialchars($productName, ENT_QUOTES, 'UTF-8') ?></strong>
                                has been approved and is now visible on the Kymera Collection storefront.
                            </p>
