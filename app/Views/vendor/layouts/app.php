...
<body>
    <div class="admin-shell">
        <nav class="admin-sidebar">
            <div class="sidebar-brand">Kymera<span>Vendor Portal</span></div>
        ...
        <div class="admin-main">
            <header class="admin-topbar">
                <div class="small text-white-50">Kymera Collection &mdash; Vendor Portal</div>
                <div class="d-flex align-items-center gap-3">
                    <span class="small"><?= e(trim(($vendorUser['first_name'] ?? '') . ' ' . ($vendorUser['last_name'] ?? ''))) ?></span>
